#!/usr/bin/env python3
"""Stage 4: Gain sweep generation for GPT-2 features."""
...
# Diverse prompts spanning many topics to reveal what each feature does
PROMPTS = [
    "The scientist discovered that the ancient",
    "In the middle of the night, the",
    "The president announced a new policy on",
    "She opened the old book and found",
    "The stock market crashed because",
    "Deep in the forest, a strange",
    "The algorithm works by first",
    "He looked at the stars and wondered",
    "The war began when the two nations",
    "Music fills the room as the piano",
    "The chemical reaction produces",
    "Walking through the city at dawn,",
    "The philosopher argued that truth is",
    "A small village in the mountains was",
    "The spacecraft entered orbit around",
    "She whispered the secret to her",
    "The recipe calls for three cups of",
    "In 1945, the world changed when",
